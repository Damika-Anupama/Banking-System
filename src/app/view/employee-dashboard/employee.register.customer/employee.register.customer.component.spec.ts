...
describe('EmployeeRegisterCustomerComponent', () => {
  ...
  describe('Successful Registration', () => {
    ...
    it('does not flag the freshly cleared fields as errors after a successful registration', async () => {
      component.username = 'johndoe';
      component.password = 'password123';
      component.fullname = 'John Doe';
      component.gender = 'male';
      ...
      // submit() marked every field touched; the reset must clear that too,
      // or the emptied form immediately lights up with nine errors.
      expect(component.errorFor('fullname')).toBeNull();
