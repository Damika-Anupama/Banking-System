...
export class SettingsComponent implements OnInit, OnDestroy {
  ...
  lastSavedAt = '';
  /** Mirror the profile/security card shapes so the loading skeletons hold the layout. */
  readonly profileSkeletonColumns = ['Field', 'Value'];
  readonly securitySkeletonColumns = ['Setting', 'Status'];
