...
This public repository contains only the frontend-only Angular deployment. The
complete Node.js/Express + Angular implementation and its history are maintained
in a private source repository, which publishes a sanitized orphan commit here
after safety checks.
